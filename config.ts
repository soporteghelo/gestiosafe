...
export const APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbyVeeaPh-txhPS2rzPVESUYU8OLeEOsfvNmmVDSv1CCnJVOtIAPMMFdKyTsqdZlXDLkmw/exec";
...
export const EXCHANGE_RATE = 3.80;
